...
export function ProjectTypeNewView() {
  const router = useRouter();
  const addType = useProjectTypeStore((s) => s.addType);
  ...
  function handleSubmit() {
    const record = addType(data);
    setFeedback(`"${record.name}" has been added.`);
    window.setTimeout(() => router.push(`/settings/project-types/${record.id}`), 1200);
  }
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div>
            ...
            <p>Define a new classification category for the project registry. Required fields are marked with *.</p>
          </div>
          <div className={styles.heroActions}>
            <Link className={styles.btnSecondary} href="/settings/project-types">
            ...
            <div className={styles.formBody}>
              {step === 0 && (
                <>
                  ...
                  <p className={styles.sectionHelp}>
                    Enter the display name and a detailed description for this project type.
                  </p>
              ...
              {step === 2 && (
                <>
                  ...
                  <p className={styles.sectionHelp}>
                    Assign the implementing department and select the fund sources eligible for projects of this type.
                  </p>
                  <div className={styles.formGrid}>
              ...
              {step === 3 && (
                <>
                  ...
                  <p className={styles.sectionHelp}>
                    Review all project type details before saving. You can go back to any step to make changes.
                  </p>
            ...
            <footer className={styles.formFooter}>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {step < steps.length - 1 ? (
                  ...
                  >
                    <Send size={14} /> Save project type
                  </button>
                )}
              </div>
            </footer>
